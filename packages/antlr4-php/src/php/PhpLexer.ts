// Generated from ./packages/antlr4-php/src/php/PhpLexer.g4 by ANTLR 4.7.3-SNAPSHOT
...
import { PhpBaseLexer } from './PhpBaseLexer';

export class PhpLexer extends PhpBaseLexer {
	...
	public static readonly PhpComments = 2;
	public static readonly ErrorLexem = 3;
	public static readonly SkipChannel = 4;
	public static readonly XML = 1;
	public static readonly INSIDE = 2;
	public static readonly HtmlQuoteStringMode = 3;
	public static readonly HtmlDoubleQuoteStringMode = 4;
	public static readonly SCRIPT = 5;
	public static readonly STYLE = 6;
	public static readonly PHP = 7;
	public static readonly InterpolationString = 8;
	public static readonly SingleLineCommentMode = 9;
	public static readonly HereDoc = 10;
	...
	public static readonly VOCABULARY: Vocabulary = new VocabularyImpl(PhpLexer._LITERAL_NAMES, PhpLexer._SYMBOLIC_NAMES, []);
	...
	constructor(input: CharStream) {
		super(input);
		this._interp = new LexerATNSimulator(PhpLexer._ATN, this);
	}

	// @Override
	public get grammarFileName(): string { return "PhpLexer.g4"; }

	// @Override
	public get ruleNames(): string[] { return PhpLexer.ruleNames; }

	// @Override
	public get serializedATN(): string { return PhpLexer._serializedATN; }

	// @Override
	public get channelNames(): string[] { return PhpLexer.channelNames; }

	// @Override
	public get modeNames(): string[] { return PhpLexer.modeNames; }
	...
	private HtmlScriptOpen_action(_localctx: RuleContext, actionIndex: number): void {
		switch (actionIndex) {
		case 0:
	...
	private HtmlStyleOpen_action(_localctx: RuleContext, actionIndex: number): void {
		switch (actionIndex) {
		case 1:
      this._styleTag = true;
			break;
	...
	private HtmlClose_action(_localctx: RuleContext, actionIndex: number): void {
		switch (actionIndex) {
		case 2:
	...
	private CloseCurlyBracket_action(_localctx: RuleContext, actionIndex: number): void {
		switch (actionIndex) {
		case 3:
	...
	private CurlyDollar_action(_localctx: RuleContext, actionIndex: number): void {
		switch (actionIndex) {
		case 4:
	...
	private PHPEnd_sempred(_localctx: RuleContext, predIndex: number): boolean {
		switch (predIndex) {
		case 1:
	...
	private StartNowDoc_sempred(_localctx: RuleContext, predIndex: number): boolean {
		switch (predIndex) {
		case 3:
	...
	private StartHereDoc_sempred(_localctx: RuleContext, predIndex: number): boolean {
		switch (predIndex) {
		case 4:
			return  this.ShouldPushHereDocMode(1) ;
		}
	...
	private CurlyDollar_sempred(_localctx: RuleContext, predIndex: number): boolean {
		switch (predIndex) {
		case 5:
	...
	private PhpStartEchoFragment_sempred(_localctx: RuleContext, predIndex: number): boolean {
		switch (predIndex) {
		case 6:
			return  this.HasAspTags() ;
		}
	...
	private PhpStartFragment_sempred(_localctx: RuleContext, predIndex: number): boolean {
		switch (predIndex) {
		case 7:
			return  this.HasAspTags() ;
		}
	...
	private static readonly _serializedATNSegment1: string =
		"\u018B\x02\xBA\u018D\x02\xBB\u018F\x02\xBC\u0191\x02\xBD\u0193\x02\xBE" +
	...
	private static readonly _serializedATNSegment2: string =
		"k\x02\x02\u0305\u0306\x07r\x02\x02\u0306\u0308\x07v\x02\x02\u0307\u0301" +
	...
	private static readonly _serializedATNSegment3: string =
		"\x02\u0639\u0138\x03\x02\x02\x02\u063A\u063B\x07a\x02\x02\u063B\u063C" +
	...
	public static get _ATN(): ATN {
		if (!PhpLexer.__ATN) {
			PhpLexer.__ATN = new ATNDeserializer().deserialize(Utils.toCharArray(PhpLexer._serializedATN));
		}
